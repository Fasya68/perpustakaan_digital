...
<head>
    ...
    function redirectDashboard() {
        window.location.href = 'index.php'; // Ganti 'dashboard.php' dengan URL dashboard Anda
    }
</script>
...
?>
    <div class="d-flex justify-content-center align-items-center vh-100">
        ...
        <form class="shadow w-450 p-3" action="profile-proses.php" method="post" enctype="multipart/form-data">
          ...
          <button type="submit" class="btn btn-primary" onclick="redirectDashboard()">Simpan</button>
