...
<div class="row">
  ...
  <div class="row"> <div class="col-xl-4 col-md-6">  <h2>Informasi Pengembalian Buku</h2>
  <p><strong>Batas waktu pengembalian adalah 2 minggu.</strong></p>
<ul>
    <li><strong>Jika setelah 2 minggu belum dikembalikan, akan dikenakan denda sebesar 2000 rupiah.</strong></li>
    <li><strong>Ada petugas perpustakaan yang akan ke kelas Anda untuk membawa kembali buku tersebut.</strong></li>
</ul>
</div>
  <div class="col-xl-1 col-lg-6">
    <img src="/assets/img/cover .jpg" alt="Deskripsi gambar" style="width: 400px;">
</div>
